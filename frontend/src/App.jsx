        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex space-x-8">
              ...
              <Link to="/trending" className="flex items-center px-3 py-2 text-gray-700 hover:text-gray-900">
                Trending News
              </Link>
            </div>
          </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="relative">
                  <div className="flex items-center border-2 border-gray-300 rounded-lg overflow-hidden">
                    <textarea
                      ...
                      disabled={loading}
                    />
                    <div className="flex flex-col gap-2 p-2 border-l border-gray-300">
                      <button
                ...
                {result && (
                  <div className="mt-8 p-4 bg-gray-50 rounded-lg">
                    ...
                    <p className={`text-lg ${
                      result.toLowerCase().includes('fake') ? 'text-red-600' : 'text-green-600'
                    }`}>
                      {result}
                    </p>
                  </div>
